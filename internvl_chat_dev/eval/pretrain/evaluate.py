...
from eval_models import InternVLChatEvalModel, OpenFlamingoEvalModel
from ok_vqa_utils import postprocess_ok_vqa_generation
from rices import RICES
from sklearn.metrics import roc_auc_score
from tqdm import tqdm
from utils import init_distributed_device, world_info_from_env
...
if os.path.exists('/mnt/hwfile'):  # T
    ...
    ds_collections = {
        'flickr': {
            'image_dir_path': '/mnt/petrelfs/share_data/chenzhe1/data/flickr30k/flickr30k-images',
            'karpathy_json_path': '/mnt/petrelfs/share_data/wangwenhai/data/flickr30k/dataset_flickr30k.json',
            'annotations_json_path': '/mnt/petrelfs/share_data/wangwenhai/data/flickr30k/dataset_flickr30k_coco_style.json',
        },
        'coco': {
...
def evaluate_vqa(
    ...
    if test_annotations_json_path is not None:
        ...
        if dataset_name == 'vqav2':
            from fill_vqa_testdev_results import fill_vqav2_test_json

            fill_fn = fill_vqav2_test_json
        elif dataset_name == 'vizwiz':
            from fill_vqa_testdev_results import fill_vizwiz_test_json
