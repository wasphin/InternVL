...
srun -p ${PARTITION} \
  ...
  --output_dir "./work_dirs/internvl_chat_husky13b_448_chinese_finetune2_try4" \
  ...
  2>&1 | tee -a "./work_dirs/internvl_chat_husky13b_448_chinese_finetune2_try4/training_log.txt"
