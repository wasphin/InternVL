...
srun -p ${PARTITION} \
  ...
  --output_dir "./work_dirs/internvl_chat_husky13b_448_chinese_finetune2_try3" \
  --meta_path "./shell/data/data_0130_zh_finetune.json" \
  ...
  2>&1 | tee -a "./work_dirs/internvl_chat_husky13b_448_chinese_finetune2_try3/training_log.txt"
