...
OUTPUT_DIR='work_dirs/internvl_chat_v1_5/internvl_chat_v1_5_internlm2_100b_dynamic_res_finetune'
...
srun -p ${PARTITION} \
  ...
  --model_name_or_path "./work_dirs/internvl_chat_v1_5/internvl_chat_v1_5_internlm2_100b_dynamic_res_pretrain/checkpoint-6700" \
