...
OUTPUT_DIR='work_dirs/internvl_chat_v1_5/internvl_chat_v1_5_hermes2_yi34b_dynamic_res_finetune_try2'
...
srun -p ${PARTITION} \
  ...
  --model_name_or_path "./work_dirs/internvl_chat_v1_5/internvl_chat_v1_5_hermes2_yi34b_dynamic_res_pretrain/checkpoint-1500" \
  --conv_style "Hermes-2" \
