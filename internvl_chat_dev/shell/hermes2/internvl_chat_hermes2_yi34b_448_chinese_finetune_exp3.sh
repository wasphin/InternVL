...
srun -p ${PARTITION} \
  ...
  --conv_style "Hermes-2" \
  --output_dir "./work_dirs/internvl_chat_hermes2_yi34b_448_chinese_finetune_exp3" \
  ...
  2>&1 | tee -a "./work_dirs/internvl_chat_hermes2_yi34b_448_chinese_finetune_exp3/training_log.txt"
