...
OUTPUT_DIR='work_dirs/internvl_chat_hermes2_yi34b_896_chinese_pretrain'
...
srun -p ${PARTITION} \
  ...
  --model_name_or_path "./work_dirs/internvl_chat_hermes2_yi34b_448_chinese_finetune_exp5_resize896" \
  --conv_style "Hermes-2" \
