...
OUTPUT_DIR='work_dirs/internvl_chat_internlm2_20b_896_chinese_pretrain'
...
srun -p ${PARTITION} \
  ...
  --vision_path "./pretrained/intern_vit_6b_896px" \
  --mlp_path "./pretrained/intern_vit_6b_896px/mlp_projector.pth" \
