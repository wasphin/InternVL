...
OUTPUT_DIR='work_dirs/internvl_chat_lite/internvl_chat_v1_5_internlm2_1_8b_dynamic_res_finetune_try9'
...
srun -p ${PARTITION} \
  ...
  --meta_path "./shell/data/data_yi34b_finetune_v5_32.json" \
