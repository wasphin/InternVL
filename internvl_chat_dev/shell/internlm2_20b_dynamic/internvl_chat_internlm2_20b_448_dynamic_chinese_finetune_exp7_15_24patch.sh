...
OUTPUT_DIR='work_dirs/internvl_chat_internlm2_20b_448_dynamic_chinese_finetune_exp7_15_24patch'
...
srun -p ${PARTITION} \
  ...
  --meta_path "./shell/data/data_yi34b_finetune_v5_15_langchao_24patch.json" \
