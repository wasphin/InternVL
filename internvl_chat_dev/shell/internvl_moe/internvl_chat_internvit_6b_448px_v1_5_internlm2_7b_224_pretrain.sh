...
OUTPUT_DIR='work_dirs/internvl_chat_internvit_6b_448px_v1_5_internlm2_7b_224_pretrain'
...
srun -p ${PARTITION} \
  ...
  --vision_path "/mnt/petrelfs/wangweiyun/workspace_cz/InternVL/internvl_chat_dev/pretrained/InternViT-6B-448px-V1-5" \
